...
$tblend = '</table>';
$sepn = ['Dashes', 'Line', 'Full horizontal line', 'None'];
$sep = ['<br><br>--------------------<br>',
...
if (in_array($loguserid, [1, 5, 2100])) {
...
if ($ipbanned) {
    ...
    exit("$header<br>$tblstart$tccell1>
