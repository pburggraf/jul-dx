...
$effects = ['None', '1: Forces female gender', '2: Forces male gender', '3: Forces catgirl status', '4: Other'];

if ($loguser['powerlevel'] < 1) {
    $windowtitle = 'nope.avi';
    require 'lib/layout.php';
    echo $header ."<br>$tblstart
			$tccell1>No.</td><table>". $footer;
    exit;
}

$hiddeneditok = in_array($loguser['id'], [1, 18]);
...
if ($_POST['edit']) {
    ...
    if ($_POST['coins'] < 0 || $_POST['gcoins'] < 0) {
        ...
        exit("You don't pay warnings much heed, do you?");
    }
