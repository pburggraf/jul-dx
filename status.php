...
function nlimiter($n)
{
    ...
    if ($n <= 9999999) {
        return number_format(floor($n / 1000), 0, '.', '') .'K';
    }
    if ($n <= 99999999) {
        return number_format(floor($n / 100000) / 10, 1, '.', '') .'M';
    }
    if ($n <= 9999999999) {
        return number_format(floor($n / 1000000), 0, '.', '') .'M';
    }
    if ($n <= 99999999999) {
        return number_format(floor($n / 100000000) / 10, 1, '.', '') .'B';
    }
