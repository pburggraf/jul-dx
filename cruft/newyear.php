...
if ($_GET['z']) {
    exit('<body bgcolor=#111122><META HTTP-EQUIV=REFRESH CONTENT=1;URL=newyear.php?z='. rand(0, 9999) .'><center><br><br><br><br><img src=newyear.php width=100%>');
}
...
$secs = explode('.', $secs);
$secs = implode('"', [str_pad($secs[0], 2, '0', STR_PAD_LEFT), str_pad($secs[1], 2, '0', STR_PAD_RIGHT)]);
...
foreach ($nums as $n) {
    ...
    if ($w) {
        imagecopymerge($image, $imagenum, $ofs, 0, $p, 0, $w, 7, 100);
    }
