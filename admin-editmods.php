...
admincheck();
echo adminlinkbar('admin-editmods.php');
...
if ($action) {
    ...
    switch ($action) {
        case 'remove':
            ...
            if (($err = mysql_error()) != '') {
                echo "$tblstart$tccell1> ERROR: $err.";
            } else {
                ...
                echo "$tblstart$tccell1> You successfully deleted user $removemoduser from forum $removemodforum.<br>".redirect('admin-editmods.php', 'go back to Edit Mods', 0);
            }
            break;
        case 'add':
            ...
            if (($err = mysql_error()) != '') {
                ...
                echo "$tblstart$tccell1> You successfully added user $addmoduser to forum $addmodforum.<br>".redirect('admin-editmods.php', 'go back to Edit Mods', 0);
            }
            break;
        default:
            print 'No, doofus.';
